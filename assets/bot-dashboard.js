/* 
	Enhanced Bot Dashboard JS v2.0.3
	Modern Vanilla JS bot protection interface
*/
...
document.addEventListener('DOMContentLoaded', function() {
	...
	document.addEventListener('click', function(e) {
		if (e.target.classList.contains('bot-tools-link')) {
			e.preventDefault();
	...
	document.addEventListener('click', function(e) {
		if (e.target.classList.contains('bot-fx-link')) {
			e.preventDefault();
	...
	document.addEventListener('mouseenter', function(e) {
		if (e.target.classList.contains('bot-row')) {
	...
	document.addEventListener('click', function(e) {
		if (e.target.classList.contains('bot-toggle-link')) {
			e.preventDefault();
	...
	// Host lookup
	document.addEventListener('click', function(e) {
		if (e.target.classList.contains('bot-hostlookup-link')) {
			e.preventDefault();
	...
	document.addEventListener('click', function(e) {
		if (e.target.classList.contains('bot-addvisit-link') || e.target.classList.contains('bot-reload-link')) {
			e.preventDefault();
			clearBotData();
	...
	document.addEventListener('click', function(e) {
		if (e.target.classList.contains('bot-reload-current')) {
			e.preventDefault();
			botDashboard.vars.type = 'init';
			loadBotActivity();
			e.target.blur();
	...
	document.addEventListener('click', function(e) {
		if (e.target.classList.contains('bot-delete-link')) {
			e.preventDefault();
			e.target.blur();
	...
	document.addEventListener('change', function(e) {
		if (e.target.classList.contains('bot-select-all')) {
	...
	document.addEventListener('change', function(e) {
		if (e.target.classList.contains('bot-id')) {
	...
	// Bulk actions
	document.addEventListener('click', function(e) {
		if (e.target.classList.contains('bot-action-bulk')) {
			e.preventDefault();
	...
	document.addEventListener('click', function(e) {
		if (e.target.classList.contains('bot-action-ban') || 
	...
	document.addEventListener('click', function(e) {
		if (e.target.classList.contains('unblock-bot')) {
			var ip = e.target.getAttribute('data-ip');
			var button = e.target;
	...
	// Pagination
	document.addEventListener('click', function(e) {
		if (e.target.classList.contains('bot-page-next')) {
			e.preventDefault();
			if (botDashboard.vars.offset < botDashboard.vars.count) {
	...
	document.addEventListener('click', function(e) {
		if (e.target.classList.contains('bot-page-prev')) {
			e.preventDefault();
	...
	document.addEventListener('keypress', function(e) {
		if (e.target.classList.contains('bot-page-jump')) {
	...
	document.addEventListener('mouseenter', function(e) {
		if (e.target.classList.contains('bot-page-items')) {
			var hoverInfo = document.querySelector('.bot-hover-info');
			if (hoverInfo) {
	...
	// Search and filter
	document.addEventListener('keypress', function(e) {
		if (e.target.classList.contains('bot-action-search')) {
			if (e.keyCode === 13 || e.which === 13) {
				e.preventDefault();
	...
	document.addEventListener('change', function(e) {
		if (e.target.classList.contains('bot-select-filter')) {
			e.preventDefault();
	...
	// Sort and order
	document.addEventListener('change', function(e) {
		if (e.target.classList.contains('bot-select-sort') || e.target.classList.contains('bot-select-order')) {
			e.preventDefault();
	...
	// Status filter
	document.addEventListener('change', function(e) {
		if (e.target.classList.contains('bot-select-status')) {
			e.preventDefault();
